...
using SearchPractice.Models;

namespace SearchPractice.Controllers
{
    public class SearchesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,UserName,Gender,Email")] Search search)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,UserName,Gender,Email")] Search search)
        {
            if (ModelState.IsValid)
            {
